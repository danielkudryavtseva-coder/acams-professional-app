    ...
    <>
      ...
      >
        ...
        <div className="relative z-10 mx-auto flex max-w-content flex-col items-center justify-end px-6 pb-14 pt-28 text-center sm:items-start sm:justify-center sm:pb-20 sm:pt-20 sm:text-left md:min-h-[28rem] md:py-24 lg:py-32">
          <h1 className="mt-6 max-w-3xl font-display text-4xl font-semibold leading-[1.1] tracking-tight drop-shadow-[0_2px_28px_rgba(0,0,0,0.5)] sm:mt-0 md:text-6xl">
          ...
          <div className="mt-5 flex w-full flex-wrap justify-center gap-3 sm:mt-8 sm:w-auto sm:justify-start">
